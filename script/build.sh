...
#
# curl -sL https://github.com/forwardcomputers/chocolatey-packages/raw/main/README.md | sed -n '/| Repository/,$p' > README.md
curl -sL https://github.com/forwardcomputers/scoop-packages/raw/main/README.md | sed -n '/| Repository/,$p' > README.md
#
